...
𖣔 Usᴇ `/scrape_dl` ᴛᴏ sᴇᴛ ᴀ ᴄʜᴀɴɴᴇʟ ᴛᴏ sᴄʀᴀᴘᴇ ʟɪɴᴋs ᴀɴᴅ `/scrape` ᴛᴏ sᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ.
"""
    
    ABOUT_TEXT ="""
╭───────────⍟
├📛 **Mʏ Nᴀᴍᴇ** : URL Uᴘʟᴏᴀᴅᴇʀ Bᴏᴛ
├📢 **Fʀᴀᴍᴇᴡᴏʀᴋ** : <a href=https://docs.pyrogram.org/>Pyrogram 2.7.1</a>
├💮 **Lᴀɴɢᴜᴀɢᴇ** : <a href=https://www.python.org>Python 3.13.5</a>
├💾 **Dᴀᴛᴀʙᴀsᴇ** : <a href=https://cloud.mongodb.com>MongoDB</a>
├🚨 **Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ** : <a href=https://t.me/i7stoical>Support</a>
├🥏 **Cʜᴀɴɴᴇʟ** : <a href=https://t.me/i7stoical>Channel</a>
├👨‍💻 **Cʀᴇᴀᴛoʀ** :  @i7stoical
╰───────────────⍟
"""
...
"""
    ...
    FF_MPEG_RO_BOT_AD_VER_TISE_MENT = "Contact @i7stoical\n If you're interested in upgrading your plan"
