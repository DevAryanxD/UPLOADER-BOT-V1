...
async def youtube_dl_call_back(bot, update):
    ...
    if t_response:
        ...
        if file_size > Config.TG_MAX_FILE_SIZE:
            ...
            upload_channel = await db.get_upload_channel(update.from_user.id)
            chat_id = int(upload_channel) if upload_channel else update.message.chat.id
            ...
            try:
                ...
                await bot.send_message(
                    ...
                    text="Failed to clean up temporary files. Please try again or contact support."
                )
